...
const SidebarItem = ({ title, icon: Icon, to, count }: SidebarItemProps) => {
  ...
  return (
    <Link
      href={to}
      className={`flex flex-row items-center justify-center px-2 py-4 rounded w-11/12 relative ${
    ...
    >
      ...
      {count && count > 0 && (
        <div className="absolute top-1/6 right-5/12 md:top-1/6 md:right-1/4">

  ...
  return (
    <div className="flex flex-col items-center w-full p-6 pb-20 md:pb-6">
      ...
      <button
        ...
        className="fixed bottom-20 right-6 w-14 h-14 bg-blue-500 text-white rounded-full shadow-lg hover:bg-blue-600 hover:shadow-xl transform hover:scale-110 transition-all duration-200 z-50 flex items-center justify-center"
      >
